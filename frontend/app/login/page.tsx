...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FFFDF9', display: 'flex', alignItems: 'stretch' }}>
      ...
      <div style={{
        flex: '0 0 45%', background: '#1A0A00', display: 'none',
        flexDirection: 'column', justifyContent: 'center', padding: '5rem 4rem',
        position: 'relative', overflow: 'hidden',
      }} className="login-left-panel">
        <div style={{ position: 'absolute', inset: 0, backgroundImage: 'url(https://images.unsplash.com/photo-1614088523011-8e0192d6e38b?q=80&w=800)', backgroundSize: 'cover', backgroundPosition: 'center', opacity: 0.15 }} />
        <div style={{ position: 'relative', zIndex: 1 }}>
          <Link href="/" style={{ textDecoration: 'none' }}>
            <span style={{ fontFamily: 'var(--font-playfair, Georgia, serif)', fontSize: '2.5rem', fontWeight: 900, fontStyle: 'italic', color: '#FFFDF9', letterSpacing: '-0.03em' }}>
              ChocoLuxe
            </span>
          </Link>
          <h2 style={{ fontFamily: 'var(--font-playfair, Georgia, serif)', fontSize: '2.5rem', fontWeight: 900, color: '#FFFDF9', lineHeight: 1.1, marginTop: '4rem', textTransform: 'uppercase' }}>
            Premium<br/>Chocolate<br/>Experience
          </h2>
          <p style={{ color: 'rgba(255,253,249,0.5)', marginTop: '1.5rem', lineHeight: 1.7 }}>
            India's finest imported chocolate destination. Authentic products from global brands.
          </p>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '5rem 2rem' }}>
        <div style={{ width: '100%', maxWidth: '400px' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            <p style={{ color: 'rgba(26,10,0,0.4)', fontSize: '0.8rem', marginTop: '0.4rem', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
          ...
          <p style={{ color: 'rgba(26,10,0,0.45)', fontSize: '0.875rem', marginBottom: '2.5rem' }}>
            Sign in to access your chocolate journey.
          </p>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <InputField id="password" label="Password" type="password" value={password} onChange={setPassword} autoComplete="current-password" placeholder="••••••••" />

            <button id="login-submit" type="submit" disabled={loading} className="btn-gold" style={{ width: '100%', justifyContent: 'center', marginTop: '0.5rem', opacity: loading ? 0.7 : 1, cursor: loading ? 'not-allowed' : 'pointer', fontSize: '0.9rem', padding: '1rem' }}>
              {loading ? (
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', margin: '2rem 0' }}>
            ...
            <span style={{ color: 'rgba(26,10,0,0.3)', fontSize: '0.75rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}>New here?</span>
            <div style={{ flex: 1, height: '1px', background: 'rgba(26,10,0,0.1)' }} />
          </div>

          <Link href="/register" className="btn-ghost" style={{ width: '100%', justifyContent: 'center', fontSize: '0.875rem', padding: '0.9rem' }}>
            Create an Account
          </Link>

          <p style={{ textAlign: 'center', marginTop: '1.5rem', color: 'rgba(26,10,0,0.3)', fontSize: '0.75rem' }}>
            By signing in you agree to our{' '}
            <a href="#" style={{ color: 'rgba(26,10,0,0.5)', textDecoration: 'underline' }}>Terms</a>
            {' & '}
            <a href="#" style={{ color: 'rgba(26,10,0,0.5)', textDecoration: 'underline' }}>Privacy Policy</a>
          </p>
        </div>
      </div>
